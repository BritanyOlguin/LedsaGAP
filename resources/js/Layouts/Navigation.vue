    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <div class="flex justify-center items-center mt-8">
            <div class="flex items-center">
                <img class="w-40 h-40" src="/storage/imgEstaticas/ledsaLogo.svg" alt="LEDSA Logo" />
            </div>
        </div>

        <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
            <div v-if="$page.props.user.permissions.includes('leer archivos')">
            ...
            <div v-if="$page.props.user.permissions.includes('leer usuario')">
            ...
            <div v-if="$page.props.user.permissions.includes('leer mis documentos')">
            ...
            <!-- Two-level menu -->
            <!-- <a class="flex items-center mt-4 py-2 px-6 text-black-100" href="#"
            ...
            <transition enter-to-class="transition-all duration-300 ease-in-out" enter-from-class="max-h-0 opacity-25"
                ...
                <div v-show="showingTwoLevelMenu">
                    <ul class="overflow-hidden p-2 mx-4 mt-2 space-y-2 text-sm font-medium text-white bg-orange-600 rounded-md shadow-inner"
                        aria-label="submenu">
